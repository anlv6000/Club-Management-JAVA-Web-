            ...
            <div class="main-panel">
                            ...
                            <div class="dropdown dropdown-primary">
                                ...
                                <div class="dropdown-menu dd-menu drop-ups dropdown-menu-end bg-white shadow border-0 mt-3 p-2" data-simplebar style="height: 175px;">
                                    <a href="javascript:void(0)" class="d-flex align-items-center">
                                        <img src="${pageContext.request.contextPath}/assets/img/language/chinese.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                    ...
                                    <a href="javascript:void(0)" class="d-flex align-items-center mt-2">
                                        <img src="${pageContext.request.contextPath}/assets/img/language/european.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                        <div class="flex-1 text-left ms-2 overflow-hidden">
                                    ...
                                    <a href="javascript:void(0)" class="d-flex align-items-center mt-2">
                                        <img src="${pageContext.request.contextPath}/assets/img/language/indian.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                        <div class="flex-1 text-left ms-2 overflow-hidden">
                                    ...
                                    <a href="javascript:void(0)" class="d-flex align-items-center mt-2">
                                        <img src="${pageContext.request.contextPath}/assets/img/language/japanese.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                        <div class="flex-1 text-left ms-2 overflow-hidden">
                                    ...
                                    <a href="javascript:void(0)" class="d-flex align-items-center mt-2">
                                        <img src="${pageContext.request.contextPath}/assets/img/language/russian.png" class="avatar avatar-client rounded-circle shadow" alt="">
                                        <div class="flex-1 text-left ms-2 overflow-hidden">
                            ...
                            <div class="dropdown dropdown-primary">
                                ...
                                <div class="dropdown-menu dd-menu dropdown-menu-end bg-white shadow border-0 mt-3 py-3" style="min-width: 200px;">
                                    <a class="dropdown-item d-flex align-items-center text-dark" href="https://shreethemes.in/doctris/layouts/admin/profile.html">
                                        <img src="${pageContext.request.contextPath}/assets/img/doctors/01.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                ...
                <div class="container">
                    <div class="d-md-flex justify-content-between">
                        <h5 class="mb-0">Member Profile & Settings</h5>
                        <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                            <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                <li class="breadcrumb-item"><a href="clublist">Club</a></li>
                            ...
                            <div class="col-12 mt-4">
                                <div class="card border-0 rounded-0 p-4">
                                    <ul class="nav nav-pills nav-justified flex-column flex-sm-row rounded shadow overflow-hidden bg-light"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link rounded-0 active shadow-none  border-0" id="overview-tab" data-bs-toggle="pill"  style="background-color: #000000b3 !important;"
                                               href="#pills-overview" role="tab" aria-controls="pills-overview"
                                               aria-selected="false">
                                                <div class="text-center pt-1 pb-1">
                                                    <h4 class="title fw-normal mb-0" style="color: #ffffff !important; transition: color 0.3s ease;">New Post</h4>
                                                </div>
                                            </a><!--end nav link-->
                                        </li><!--end nav item-->
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link rounded-0 shadow-none border-0" id="settings-tab" data-bs-toggle="pill"  style="background-color: #000000b3 !important;"
                                    ...
                                    <div class="tab-content mt-2" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-overview" role="tabpanel"
                                            ...
                                            <p class="text-muted d-flex align-items-center">
                                                ...
                                                <span class="badge ${latestPost.status eq 'Published' ? 'bg-success' : 'bg-secondary'} ms-3">
                                                    ${latestPost.status}
                                                </span>
                                            </p>

                                            <!-- Nội dung bài viết -->
                                            <p class="text-dark">${latestPost.description}</p>

                                            <!-- Hình ảnh bài viết -->
                                            <div class="text-left">
                                                <img src="${pageContext.request.contextPath}/images/FPT1.jpg" 
                                                    ...
                                                    <div class="col mt-4">
                                                        <div class="card team border-0 rounded shadow overflow-hidden">
                                                            <div class="team-person position-relative overflow-hidden">
                                                                <img src="${member.imageURL}"class="img-fluid" alt="Profile Picture" height="155px>                                                          </div>
                                                            <div class="card-body">
                                                                <!-- Tên thành viên -->
