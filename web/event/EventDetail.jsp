        ...
        <div class="club-container">
            ...
            <div class="club-section">
                ...
                <div class="content" id="eventType">
                    <label><input type="radio" name="eventType" value="Online"> Online</label>
                    <label><input type="radio" name="eventType" value="Offline"> Offline</label>
                </div>
            </div>
            
            <div class="club-section">
                <label for="eventStatus">Event Status</label>
                <div class="content" id="eventStatus">
                    <label><input type="radio" name="eventStatus" value="Active"> Active</label>
                    <label><input type="radio" name="eventStatus" value="Inactive"> Inactive</label>
                </div>
            </div>
