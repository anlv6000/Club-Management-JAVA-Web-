...
<html>
    ...
    <body>
        <div class="club-container">
            <h1>Add New Event</h1>
            <h2><a href="EventList.jsp" class="event-list-link">Event List</a></h2>
            <form action="addEvent" method="post" onsubmit="validateForm(event)">
                ...
                <div class="club-section">
                    ...
                    <div class="radio-group">
                        <label><input type="radio" name="eventType" value="Online" required> Online</label>
                        <label><input type="radio" name="eventType" value="Offline" required> Offline</label>
                    </div>
                ...
                <div class="club-section">
                    ...
                    <div class="radio-group">
                        <label><input type="radio" name="eventStatus" value="Active" required> Active</label>
                        <label><input type="radio" name="eventStatus" value="Inactive" required> Inactive</label>
                    </div>
                    <span class="error-message">Please select an option.</span>
                </div>
                <div class="club-section">
