...
<c:if test="${not empty sessionScope.errorMessage}">
    ...
    <div class="grid grid-cols-2 gap-4"> <!-- Chia thành 2 cột -->
        <div class="form-group">
            <label for="username">Username: <span class="text-red-500">*</span><span class="text-red-500 ml-2"></span></label>
            <input type="text" id="username" name="username" placeholder="Enter name" value="${username}" required>
            <c:if test="${not empty usernameError}">
                <div class="error-message">${usernameError}</div>
            </c:if>
        </div>
              <div class="form-group">
            <label for="fullname">Fullname: <span class="text-red-500">*</span><span class="text-red-500 ml-2"></span></label>
            <input type="text" id="fullname" name="fullname" placeholder="Enter fullname" value="${fullname}" required>
