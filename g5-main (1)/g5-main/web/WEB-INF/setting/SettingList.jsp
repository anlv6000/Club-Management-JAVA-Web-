    ...
    <body>
        ...
        <div class="container">
            ...
            <div>
                ...
                <form action="newSetting" method="get" style="float: right;">
                ...
                <tbody>
                    <c:forEach var="setting" items="${settingsList}">
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${setting.roleId == 1}">Web User</c:when>
                                    <c:when test="${setting.roleId == 2}">Club Member</c:when>
                                    <c:when test="${setting.roleId == 3}">Club Leader</c:when>
                                    <c:when test="${setting.roleId == 4}">Event Leader</c:when>
                                    <c:when test="${setting.roleId == 5}">Project Leader</c:when>
                                    <c:when test="${setting.roleId == 6}">Admin</c:when>
                            ...
                            <td>
                                <a href="updateSetting?id=${setting.id}">
                                    <img src="https://cdn-icons-png.flaticon.com/256/5253/5253658.png" alt="Edit" class="button-icon" />
                                </a>
                                <a href="toggleStatus?id=${setting.id}&currentStatus=${setting.status}">
                                    <img src="${setting.status == 'Active' ? 'https://th.bing.com/th/id/OIP.p-XzV8VN9OT9p7qg11BQcQAAAA?rs=1&pid=ImgDetMain' : 'https://e7.pngegg.com/pngimages/661/209/png-clipart-kosher-foods-kosher-certification-agency-orthodox-union-hechsher-others-food-text.png'}" 
                                         alt="${setting.status == 'Active' ? 'Deactivate' : 'Activate'}" class="button-icon2" />
                                </a>
                            </td>
                        </tr>
                    </c:forEach>
