...
<jsp:include page="header.jsp"></jsp:include>
    ...
    <body>
        ...
        <c:if test="${not empty sessionScope.successMessageProject}">
            <div id="success-messageProject"
                 style="position: fixed; top: 250px; left: 50%; transform: translateX(-50%);
                 background: green; color: white; padding: 10px 20px;
                 border-radius: 5px; z-index: 1000;">
                ${sessionScope.successMessageProject}
            </div>
            <c:remove var="successMessageProject" scope="session"/>
        </c:if>
        <div class="container" >
            ...
            <div class="content" style="">
                <div class="table-wrapper">
                    <div class="table-title">
                        ...
                        <c:if test="${sessionScope.accc.role == 'ClubLeader' ||sessionScope.acc.role == 'ClubLeader' }">
                            <a href="AddProject"  class="btn btn-success">Add New Project</a>
                        </c:if>
