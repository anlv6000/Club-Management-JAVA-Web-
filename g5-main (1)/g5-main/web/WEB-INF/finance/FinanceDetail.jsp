    ...
    <head>
        ...
        <body>
            ...
            <div class="form-container">
                <form action="financeDetail" method="post" enctype="multipart/form-data">
                ...
                <div style="display: flex; align-items: flex-start; gap: 20px;">
                    <div class="form-group" style="flex: 1;">
                        ...
                        <input type="text" id="clubName" name="clubName" value="${finance.clubName}" readonly>
                    </div>
                    <div class="form-group" style="flex: 1;">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" id="financeDate" name="financeDate" value="${finance.financeDate}" required>
                </div>
                <div style="display: flex; align-items: flex-start; gap: 20px;">
                    <div class="form-group" style="flex: 1;">
                ...
                <div class="form-group">
                    ...
                    <textarea id="details" name="details">${finance.details}</textarea>
                </div>



                <!-- Phần hình ảnh -->
                <c:if test="${not empty finance.imgurl}">
                    <div class="form-group">
                        <label for="proofImage">Current Proof Image</label>
                        <div>
                            <img src="${finance.imgurl}" alt="Proof Image" style="max-width: 1000px; max-height: 1000px; border: 5px solid #ccc;" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="newProofImage">Upload New Proof Image</label>
                        <input type="file" id="newProofImage" name="newProofImage" accept="image/*" />
                    </div>
                </c:if>
                ...
                <div class="form-group" style="align-items: center; margin-top: 20px;">
                    <div class="buttons">
                        ...
                        <a href="${pageContext.request.contextPath}/finance?action=list" class="btn" style=" margin-left: 35%; margin-top: 20px;">Back to list</a>
                    </div>
                </div>
