                            ...
                            <div class="row placeani">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <c:if test="${param.fullname == null}" ><label>Fullname</label></c:if>
                                            <input name="fullname" type="text" class="form-control" value="${param.fullname}" required="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <c:if test="${param.user == null}" ><label>Username</label></c:if>
                                            <input name="user" type="text" required="" class="form-control" value="${param.user}" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <c:if test="${param.email == null}" ><label>Your Email Address</label></c:if>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group"> 
                                            <c:if test="${param.pass == null}" ><label>Your Password</label></c:if>
                                            <input name="pass" type="password" id="password" class="form-control" required="" value="${param.pass}">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group"> 
                                            <c:if test="${param.repass == null}" ><label>Verify Password</label></c:if>
                                            <input name="re_pass" type="password"  id="verification" class="form-control" required="" value="${param.repass}">
