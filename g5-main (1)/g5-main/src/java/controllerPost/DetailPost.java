...
public class DetailPost extends HttpServlet {
    ...
    throws ServletException, IOException {
        String postID_raw = request.getParameter("post_id");
        ...
        List<Post> list = postdao.getRecentPosts();
        request.setAttribute("list", list);
        request.setAttribute("e", post);
        request.getRequestDispatcher("WEB-INF/post/DetailPost.jsp").forward(request, response);
    } 
