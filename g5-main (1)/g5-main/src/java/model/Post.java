...
public class Post {
    ...
    public Post(String namecreated, String namclub) {
        this.namecreated = namecreated;
        this.nameclub = namclub;
    }
    ...
    public Post(int post_id, int user_id, int club_id, int view, String image_url, String Status, String description, String title, String post_at, String namecreated, String namclub) {
        this.post_id = post_id;
        this.user_id = user_id;
        this.club_id = club_id;
        this.view = view;
    ...
    public String toString() {
        return "Post{" + "post_id=" + post_id + ", user_id=" + user_id + ", club_id=" + club_id + ", view=" + view + ", image_url=" + image_url + ", Status=" + Status + ", description=" + description + ", title=" + title + ", post_at=" + post_at + ", namecreated=" + namecreated + ", namclub=" + nameclub + '}';
    }
