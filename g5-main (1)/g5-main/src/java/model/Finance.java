...
public class Finance {
    ...
    public Finance(int clubId, int memberId, String financeName, String isExpense, BigDecimal amount, LocalDateTime financeDate, String details, String clubName, String memberName, String status, LocalDateTime updatedDate, String imgurl) {
        this.clubId = clubId;
        this.memberId = memberId;
        this.financeName = financeName;
        this.isExpense = isExpense;
        ...
        this.imgurl = imgurl; // Đường dẫn hình ảnh
    }
