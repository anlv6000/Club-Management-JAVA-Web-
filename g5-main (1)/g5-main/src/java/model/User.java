...
public class User {
    ...
    public User(String userName, String password, String imageURL, String role) {
        this.userName = userName;
...
public User(int id, String userName, String email, String role, String fullname, String status, String text, boolean isUpdating) {
    this.id = id;
    this.userName = userName;
    this.email = email;
    this.role = role;
    ...
    public String toString() {
        return "User{" + "id=" + id + ", userName=" + userName + ", email=" + email + ", password=" + password + ", LastLoginDate=" + LastLoginDate + ", accountCreatedDate=" + accountCreatedDate + ", imageURL=" + imageURL + ", role=" + role + ", fullname=" + fullname + ", status=" + status + ", text=" + text + ", clubs=" + clubs + ", events=" + events + '}';
    }
