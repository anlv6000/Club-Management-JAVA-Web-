 ...
 * @author User
 */
@WebServlet(name="ViewPublicClubDetail", urlPatterns={"/ViewPublicClubDetail"})
public class ViewPublicClubDetail extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewPublicClubDetail</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewPublicClubDetail at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
