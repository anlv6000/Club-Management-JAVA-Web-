...
public class ClubListUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((category == null || category.trim().isEmpty()) && (nameClub == null || nameClub.isEmpty())) {
        ...
        if(!nameClub.isEmpty()){
            listClubs = dao.getClubbyname(nameClub);
 ...
 request.setAttribute("listEvent", listEvent);
        ...
        if (category.equalsIgnoreCase("all") && nameClub.isEmpty()) {
